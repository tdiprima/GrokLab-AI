...
def main(file_path):
    ...
    if total_tokens > MAX_TOKENS:
        ...
        for i, chunk in enumerate(chunks):
            ...
            summary = summarize_with_grok(
                chunk, api_key, max_output_words=100, is_chunk=True
            )
        ...
        final_summary = summarize_with_grok(
            combined_summaries, api_key, max_output_words=300
        )
    else:
